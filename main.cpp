...
//cout<<"line 31 ok"<<endl;
   c.moveBack(3,5,4);
//cout<<"line 32 ok"<<endl;
...
//cout<<"line 44 ok"<<endl;
   Chain d(png1,16);
//cout<<"line 46 ok"<<endl;
   d.reverseSub(2,15);
//cout<<"line 47 ok"<<endl;
...
//cout<<"line 55 ok"<<endl;
   Chain e(png1,36);
   Chain g(e); // quick test of copy constructor
//cout<<e.size()<<"; other:"<<g.size()<<endl;
   Chain f(result1,36);
//cout<<"line 59 ok"<<endl;
   g.weave(f);
//cout<<"line 60 ok"<<endl;
